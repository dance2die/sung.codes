// Credit Kent. C. Dodds
// https://github.com/kentcdodds/kentcdodds.com/blob/master/src/components/social.js
/** @jsx jsx */
...
const getHoverColor = isDefault =>
  isDefault ? lighten("gray.3", 0.4) : darken("gray.3", 0.4)
  ...
  return (
    <Link
      ...
      sx={{
        ...
        "&:hover": {
          color: getHoverColor(colorMode === "default"),
        },
      }}
    >
      <svg
